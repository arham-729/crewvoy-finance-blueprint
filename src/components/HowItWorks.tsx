  ...
  return (
    <section id="how-it-works" className="section-padding relative overflow-hidden border-t border-border">
      ...
      <div className="relative container-x">
        ...
        <Stagger className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-border mt-px">
          {steps.map((step) => (
            <StaggerItem key={step.num}>
              <div className="bg-background p-8 md:p-10 group hover:bg-card transition-colors h-full">
